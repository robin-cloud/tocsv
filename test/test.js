...
describe('tocsv', function() {
  ...
  it('should parse json to csv', function(done) {
    tocsv({data: _in, fields: ['carModel', 'price', 'color']}, function(err, csv) {
...
/*  
  it('should callback an error if field is not a key in the json data', function(done) {
    tocsv({data: _in, fields: ['carModel', 'location', 'color']}, function(err, csv) {
...
*/  
  it('should output only selected fields', function(done) {
    tocsv({data: _in, fields: ['carModel', 'price']}, function(err, csv) {
  ...
  it('should output reversed order', function(done) {
    tocsv({data: _in, fields: ['price', 'carModel']}, function(err, csv) {
  ...
  it('should escape quotes with double quotes', function(done) {
    tocsv({data: _in_quotes, fields: ['a string']}, function(err, csv) {
      csv.should.equal(_out_quotes);
      done();
    })
  });

  it('should use a custom delimiter when \'delimiter\' property is present', function(done) {
    tocsv({data: _in, fields: ['carModel', 'price', 'color'], delimiter:'\t'}, function(err, csv) {
      csv.should.equal(_out_tsv);
      done();
    })
  })
  
  it('should name columns as specified in \'fields.label\' property', function(done) {
    tocsv({data: _in, fields: [ { name: 'carModel', label: 'Car Model' }, { name: 'price', label: 'Price USD' } ]}, function(err, csv) {
